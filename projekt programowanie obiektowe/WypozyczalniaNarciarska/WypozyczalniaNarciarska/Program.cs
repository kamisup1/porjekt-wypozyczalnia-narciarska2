...
namespace WypozyczalniaNarciarska
{
    class Program
    {
        ...
        {
            var klienci = PlikiDane.WczytajKlient(".\\tekstowe\\Klienci2.txt");
            var kije = PlikiDane.WczytajKije(".\\tekstowe\\Kije2.txt");
            var buty = PlikiDane.WczytajButyNarciarskie(".\\tekstowe\\Buty.txt");
            var narty = PlikiDane.WczytajNarty(".\\tekstowe\\Narty.txt");
            var kaski = PlikiDane.WczytajKaski(".\\tekstowe\\Kaski.txt");
